<?php /* Smarty version Smarty-3.1.15, created on 2014-04-30 16:28:24
         compiled from "..\..\templates\users\register.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4323536101e4cabb63-61908643%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '250a80bc51b12011e675c953db17b2b9813c1a81' => 
    array (
      0 => '..\\..\\templates\\users\\register.tpl',
      1 => 1398868030,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4323536101e4cabb63-61908643',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_536101e4dd0b28_49039232',
  'variables' => 
  array (
    'BASE_URL' => 0,
    'FORM_VALUES' => 0,
...
<?php if ($_valid && !is_callable('content_536101e4dd0b28_49039232')) {function content_536101e4dd0b28_49039232($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('common/header.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
actions/users/register.php" method="post" accept-charset="UTF-8" role="form">
     <div class="form-group">
         <label for="inputName" class="col-sm-2 control-label">Nome</label>
         <div class="col-sm-10">
             <input type="text" class="form-control" id="inputName" name="username" placeholder="Nome de Utilizador" value="<?php echo $_smarty_tpl->tpl_vars['FORM_VALUES']->value['username'];?>
">
         </div>
     </div>
     <div class="form-group">
         ...
         <div class="col-sm-10">
             <input type="text" class="form-control" id="inputRealName" name="realname" placeholder="Nome Completo" value="<?php echo $_smarty_tpl->tpl_vars['FORM_VALUES']->value['realname'];?>
">
         </div>
     </div>
     <div class="form-group">
         ...
         <div class="col-sm-10">
             <input type="email" class="form-control" id="inputEmail" name="email" placeholder="Email" value="<?php echo $_smarty_tpl->tpl_vars['FORM_VALUES']->value['email'];?>
">
         </div>
     </div>
     <div class="form-group">
